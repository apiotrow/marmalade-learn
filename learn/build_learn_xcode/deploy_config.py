...
config = {}
cmdline = ['/Applications/Marmalade.app/Contents/s3e/makefile_builder/mkb.py', '/Users/aaronpiotrowski/MarmaladeProjects/learn/learn/learn.mkb', '--buildenv=XCODE', '--release', '--arm', '--compiler=gcc', '--no-ide', '--make', '--deploy-only']
