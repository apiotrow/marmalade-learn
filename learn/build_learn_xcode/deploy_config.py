...
config = {}
cmdline = ['/Applications/Marmalade.app/Contents/s3e/makefile_builder/mkb.py', '/Users/aaronpiotrowski/MarmaladeProjects/learn/learn/learn.mkb', '--buildenv=XCODE', '--debug', '--arm', '--compiler=gcc', '--no-ide', '--make', '--deploy-only']
...
assets['Default'] = [
    ('/Users/aaronpiotrowski/MarmaladeProjects/learn/learn/data', '.', 0),
]
