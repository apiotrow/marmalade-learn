...
set -e
set -x
cp "$BUILT_PRODUCTS_DIR/$EXECUTABLE_PATH" "/Users/aaronpiotrowski/MarmaladeProjects/learn/learn/build_learn_xcode/build/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}"
